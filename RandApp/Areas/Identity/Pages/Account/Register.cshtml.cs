...
namespace RandApp.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IRepository<User> customUserRepo,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _customUserRepo.CreateAsync(new RandApp.Models.User() { FirstName = Input.FirstName, LastName = Input.LastName, Age = Input.Age, Gender = Input.Gender, AccountId = user.Id });
